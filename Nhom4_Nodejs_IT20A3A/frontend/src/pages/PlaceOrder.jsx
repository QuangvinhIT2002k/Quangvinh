        ...
        <div className="order-container">
            <div className="order-row">
                <div className="order-col">
                    <h2 className='order-title'>Xem trước đơn hàng</h2>
                </div>
                <div className="order-col">
            ...
            <div className="order-row">
                <div className="order-col">
                    <div className="order-shipping">
                        <h4 className="order-shipping-title">đang xử lý:</h4>
                    ...
                    <div className="order-items">
                        <h4 className="order-items-title">Khóa học:</h4>
                ...
                <div className="order-col">
                    <h2 className='order-summary'>theo thứ tự</h2>
                    ...
                    <div className="order-summary-button">
                        <button type="button" onClick={placeOrderHandler} disabled={cart.cartItems.length === 0}>Đặt mua</button>
                    </div>
